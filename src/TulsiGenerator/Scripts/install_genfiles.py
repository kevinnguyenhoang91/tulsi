...
"""Symlinks files generated by Bazel into _tulsi-xcode for indexing."""
...
class Installer(object):
  """Symlinks generated files into _tulsi-xcode."""
  ...
  def __init__(self, bazel_exec_root, preserve_tulsi_includes=True,
    ...
    self.tulsi_root = os.path.join(output_root, '_tulsi-xcode')
